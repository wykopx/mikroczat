...
}(this, (function ()
{
    ...
    Gutter.prototype.getRawTracks = function getRawTracks()
    {
        ...
        console.log("getRawTracks() -> tracks", tracks)
        if (!tracks.length)
        {
        ...
        console.log("getRawTracks() -> ", tracks)
        return tracks[0]
    };
    ...
    {
        console.log("raw", raw);        // raw: [startArea] 10px [gutterCol1] var(--gutterWidth) [centerArea] 1fr [gutterCol3] var(--gutterWidth) [rightArea] 400px [endArea]
        this.tracks = raw.split(' ');
        console.log("tracks (after raw.split(' ')", this.tracks)
        this.trackValues = parse(raw);
        console.log("trackValues after parse(raw)", this.trackValues);
    };
